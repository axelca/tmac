  ...
  <>
    <main>
      ...
      <Article
        title="Videos"
        videos={[
          "https://www.youtube.com/embed/GqL1P49btwM",
      ...
      >
        ...
        <Typography>
          ...
          actions. Singer and founder of the band Elias has a long love story
          with Cuba. Naturally introduced to the island by the mother of his
          child 7 years ago, Elias formed a strong bond to its people and their
          outlook on life. It became a new home away from home.
        </Typography>
        <Typography>
          ...
          personal longing to dig deep from within and create something new and
          honest. The eclectic fusion between Scandinavian rock traditions and
